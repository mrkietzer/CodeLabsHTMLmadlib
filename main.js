...
const story = `Today was a <b>${adj1}</b> day.  Things started out <b>${adj2}</b> because I forgot my <b>${noun1}</b>.  As I was eating a <b>${food}</b>, suddenly I <b>${verb1}</b> my <b>${bodyPart}</b> and made a mess, but I wiped it off with my <b>${clothing}</b>`
...
//Javascript Form Validation, Prevent Empty Forms
